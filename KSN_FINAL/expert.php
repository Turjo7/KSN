        ...
        <div class="modal fade" id="expModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">My Own Event Info</h4>
                </div>
...
<section >
     <div class=" container call_section" >
        ...
        <div style="margin-left:400px;">
            <h4>Name : Dr.Nurul Huda</h4>
            <h4>Job : Professor</h4>
            <h4>Email : abc@gmail.com</h4><br>
            <button href="#" class="btn btn-danger p-3 w-5 eventinfo" style=" width:120px;">Event Logs</button>
            <button  href="#" class="btn btn-warning p-3" style=" width:150px;">Video call</button>
        </div>
...
<section >
          <div class="up">
                ...
                <input type="search" class="search_info" id="search_info" placeholder="search" style="margin-left: 900px;height:40px;width:250px;color:black;transform:translate(100px,-44px);">
            </div>
  ...
  <?php
            try {
                ...
                foreach ($table as $row) {
                    ...
                    echo       '<img src="seminar1.jpg" alt="back banner">';
                    echo   '</div>';
                    echo    '<div class="profile-image">';
                    echo       '<img src="seminar2.jpg" alt="Front pic">';
                    echo  '</div>';
...
<!--starting of create event section-->
  <section>
            <div class="up" style="margin-top:7px;">
                    <h2 style=" margin-left: 500px;padding-top:30px;color:white">Create an Event</h2>
            ...
            <div class="container" style="height:500px;" >
                ...
                <form action="create_event.php" method="POST">
                    ...
                    <label for="name" class=" mt-5">Event-Name:</label>
                    <input type="text" class="form-control" id="event_name" placeholder="Enter event_name" name="event_name">
                    </div>

                    <div class="form-group">
                    <label for="topic">Topics:</label>
                    <input type="text" class="form-control" id="topic" placeholder="Enter topics" name="topic">
                    </div>
...
<!--ending of create event section-->
                ...
                //ajax request
                 $.ajax({
                     ...
                     success:function(response){
                         $(".modal-body").html(response);//adding response in modal body
                         $("#expModal").modal('show');//display modal
